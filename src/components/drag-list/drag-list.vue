<template>
    <div class="drag-lisg-wrapper">
        <div class="drag-list-con con1">
            <slot name="left-title"></slot>
            <draggable class="drag-box1" :class="dropConClass.left" :options="options" :value="list1" @input="handleListChange($event, 'left')" @end="handleEnd($event, 'left')">
...
export default {
    ...
    methods: {
        handleListChange (value, type) {
            if (type === 'left') this.$emit('update:list', value)
